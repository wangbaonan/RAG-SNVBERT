...
python run.py \
    ...
    --output_path /cpfs01/projects-HDD/humPOG_HDD/wbn_24110700074/RAG_Version/VCF-Bert/00_Data_20250320/41_RAG-SNVBert_Data/output_rag_20250401_DynamicGateFusion/rag_bert.model \
    --dims 16 \
    --layers 4 \
    --attn_heads 2 \
    --train_batch_size 64 \
