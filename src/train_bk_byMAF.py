...
from .main import BERTTrainer, AdaptiveMaskScheduler
...
def train():
    ...
    print("Creating Mask Scheduler")
    mask_scheduler = AdaptiveMaskScheduler(
        base_ratio=0.3, 
        max_ratio=0.9, 
        strategy='cosine'
    )
    ...
    rag_train_data_loader = DataLoader(
        ...
        collate_fn=lambda batch_list: rag_collate_fn_with_dataset(batch_list, rag_train_dataset, 3)# FAISS TopK K=3
    )
