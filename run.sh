...
python run.py \
    --train_dataset data/New_VCF/Train/KGP.chr21.Train.vcf.h5 \
    --train_panel data/traindata_520_42_KGP_info_new.txt \
    --refpanel_path data/New_VCF/Panel/KGP.chr21.Panel.vcf.gz \
    ...
    --output_path output_rag_test20250304/bert_test20250320.model \
    --dims 16 \
    --layers 4 \
    --attn_heads 2 \
