...
# 创建日志和数据目录
LOG_DIR="logs/v18_embedding_rag_fixed_window_maf"
METRICS_DIR="metrics/v18_embedding_rag_fixed_window_maf"
mkdir -p ${LOG_DIR}
mkdir -p ${METRICS_DIR}
...
python -m src.train_embedding_rag \
    ...
    \
    --output_path /cpfs01/projects-HDD/humPOG_HDD/wbn_24110700074/RAG_Version/VCF-Bert/00_Data_20250320/41_RAG-SNVBert_Data/output_v18_embrag_fixed_window_maf/rag_bert.model \
    \
    --dims 384 \
    --layers 12 \
    --attn_heads 12 \
