...
BASE_INPUT_DIR="data/New_VCF/Test/TestData/Test3"
BASE_OUTPUT_PREFIX="infer_output_rag_Test3_mask"
...
for mask in $(seq 10 10 90); do
    # 构建输入文件路径
    input_vcf="${BASE_INPUT_DIR}/KGP.chr21.Test3.Mask${mask}.vcf.gz"
